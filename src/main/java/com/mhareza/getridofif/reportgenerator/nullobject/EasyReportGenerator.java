...
public class EasyReportGenerator {

	private final TransactionRepository transactionRepository;

	public EasyReportGenerator(TransactionRepository transactionRepository) {
		this.transactionRepository = transactionRepository;
	}

	public List<String> generate(Date startDate, @Nullable Date endDate, @Nullable ProgressListener listener) {
		if (endDate == null) {
			endDate = new Date();
		}
		if (listener == null) {
